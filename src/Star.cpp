...
void Star::Render(Graphics::Renderer *renderer, Camera *camera, GraphicCollector &collector, const vector3d &viewCoords, const matrix4x4d &viewTransform)
{
	...
	TerrainBody::Render(renderer, camera, collector, viewCoords, viewTransform);
}
