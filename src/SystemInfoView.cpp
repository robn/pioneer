...
void SystemInfoView::SystemChanged(const SystemPath &path)
{
	...
	m_sbodyInfoTab = new Gui::Fixed(float(GetContext()->screen->GetWidth()), float(GetContext()->screen->GetHeight()-100));
	...
	m_econInfoTab = new Gui::Fixed(float(GetContext()->screen->GetWidth()), float(GetContext()->screen->GetHeight()-100));
