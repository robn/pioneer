...
void WorldView::InitObject()
{
	...
	Add(m_hudFuelGauge, 5.0f, GetContext()->screen->GetHeight() - 104.0f);
...
void WorldView::Draw()
{
	...
	if (GetCamType() == WorldView::CAM_FRONT)
		DrawCrosshair(GetContext()->screen->GetWidth()/2.0f, GetContext()->screen->GetHeight()/2.0f, HUD_CROSSHAIR_SIZE, white);
	else if (GetCamType() == WorldView::CAM_REAR)
		DrawCrosshair(GetContext()->screen->GetWidth()/2.0f, GetContext()->screen->GetHeight()/2.0f, HUD_CROSSHAIR_SIZE/2.0f, white);
