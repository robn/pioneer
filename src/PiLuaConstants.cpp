...
void PiLuaConstants::RegisterConstants(lua_State *L)
{
	...
	_setfield(SBody::TYPE_PLANET_SMALL_GAS_GIANT,       "PLANET_SMALL_GAS_GIANT");
	_setfield(SBody::TYPE_PLANET_MEDIUM_GAS_GIANT,      "PLANET_MEDIUM_GAS_GIANT");
	_setfield(SBody::TYPE_PLANET_LARGE_GAS_GIANT,       "PLANET_LARGE_GAS_GIANT");
	_setfield(SBody::TYPE_PLANET_VERY_LARGE_GAS_GIANT,  "PLANET_VERY_LARGE_GAS_GIANT");
	_setfield(SBody::TYPE_PLANET_ASTEROID,              "PLANET_ASTEROID");
	_setfield(SBody::TYPE_PLANET_LARGE_ASTEROID,        "PLANET_LARGE_ASTEROID");
	_setfield(SBody::TYPE_PLANET_DWARF,                 "PLANET_DWARF");
	_setfield(SBody::TYPE_PLANET_SMALL,                 "PLANET_SMALL");
	_setfield(SBody::TYPE_PLANET_WATER,                 "PLANET_WATER");
	_setfield(SBody::TYPE_PLANET_DESERT,                "PLANET_DESERT");
	_setfield(SBody::TYPE_PLANET_CO2,                   "PLANET_CO2");
	_setfield(SBody::TYPE_PLANET_METHANE,               "PLANET_METHANE");
	_setfield(SBody::TYPE_PLANET_WATER_THICK_ATMOS,     "PLANET_WATER_THICK_ATMOS");
	_setfield(SBody::TYPE_PLANET_CO2_THICK_ATMOS,       "PLANET_CO2_THICK_ATMOS");
	_setfield(SBody::TYPE_PLANET_METHANE_THICK_ATMOS,   "PLANET_METHANE_THICK_ATMOS");
	_setfield(SBody::TYPE_PLANET_HIGHLY_VOLCANIC,       "PLANET_HIGHLY_VOLCANIC");
	_setfield(SBody::TYPE_PLANET_INDIGENOUS_LIFE,       "PLANET_INDIGENOUS_LIFE");
	_setfield(SBody::TYPE_PLANET_TERRAFORMED_POOR,      "PLANET_TERRAFORMED_POOR");
	_setfield(SBody::TYPE_PLANET_TERRAFORMED_GOOD,      "PLANET_TERRAFORMED_GOOD");
