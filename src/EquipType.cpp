...
const EquipType Equip::types[Equip::TYPE_MAX] = {
	{ "None", 0,
	  ...
	  Equip::SLOT_CARGO, -1, {},
	  100, 1, 0, StarSystem::PROD_MINING, 0,
	},{
	  ...
	  150, 1, 0, StarSystem::PROD_MINING, 0,
	},{
	  "Metal ore", 0,
	  Equip::SLOT_CARGO, -1, { Equip::MINING_MACHINERY },
	  300, 1, 0, StarSystem::PROD_MINING, 0,
	},{
	  ...
	  Equip::SLOT_CARGO, -1, { Equip::MINING_MACHINERY },
	  500, 1, 0, StarSystem::PROD_MINING, 0,
	},{
	  "Metal alloys", 0,
	  Equip::SLOT_CARGO, -1, { Equip::METAL_ORE, Equip::INDUSTRIAL_MACHINERY },
	  800, 1, 0, StarSystem::PROD_INDUSTRY, 1,
	},{
	  "Plastics", 0,
	  Equip::SLOT_CARGO, -1, { Equip::CARBON_ORE, Equip::INDUSTRIAL_MACHINERY },
	  1200, 1, 0, StarSystem::PROD_INDUSTRY, 2,
	},{
	  "Fruit and Veg", 0,
	  Equip::SLOT_CARGO, -1, { Equip::FARM_MACHINERY, Equip::FERTILIZER },
	  1200, 1, 0, StarSystem::PROD_AGRICULTURE, 1,
	},{
	  "Animal Meat", 0,
	  Equip::SLOT_CARGO, -1, { Equip::FARM_MACHINERY, Equip::FERTILIZER },
	  1800, 1, 0, StarSystem::PROD_AGRICULTURE, 1,
	},{
	  "Live Animals", 0,
	  Equip::SLOT_CARGO, -1, { Equip::FARM_MACHINERY, Equip::FERTILIZER },
	  3200, 1, 0, StarSystem::PROD_AGRICULTURE, 1,
	},{
	  "Liquor", 0,
	  Equip::SLOT_CARGO, -1, { Equip::FARM_MACHINERY, Equip::FERTILIZER },
	  800, 1, 0, StarSystem::PROD_AGRICULTURE, 1,
	},{
	  "Grain", 0,
	  Equip::SLOT_CARGO, -1, { Equip::FARM_MACHINERY, Equip::FERTILIZER },
	  1000, 1, 0, StarSystem::PROD_AGRICULTURE, 1,
	},{
	  "Textiles", 0,
	  Equip::SLOT_CARGO, -1, { Equip::PLASTICS },
	  850, 1, 0, StarSystem::PROD_INDUSTRY, 2,
	},{
	  "Fertilizer", 0,
	  Equip::SLOT_CARGO, -1, { Equip::CARBON_ORE },
	  400, 1, 0, StarSystem::PROD_INDUSTRY, 2,
	},{
	  "Water", 0,
	  Equip::SLOT_CARGO, -1, { Equip::MINING_MACHINERY },
	  120, 1, 0, StarSystem::PROD_MINING, 0,
	},{
	  "Medicines",0,
	  Equip::SLOT_CARGO, -1, { Equip::COMPUTERS, Equip::CARBON_ORE },
	  2200, 1, 0, StarSystem::PROD_INDUSTRY, 3,
	},{
	  "Consumer goods",0,
	  Equip::SLOT_CARGO, -1, { Equip::PLASTICS, Equip::TEXTILES },
	  14000, 1, 0, StarSystem::PROD_INDUSTRY, 4,
	},{
	  "Computers",0,
	  Equip::SLOT_CARGO, -1, { Equip::PRECIOUS_METALS, Equip::INDUSTRIAL_MACHINERY },
	  8000, 1, 0, StarSystem::PROD_INDUSTRY, 5,
	},{
	  "Robots",0,
	  Equip::SLOT_CARGO, -1, { Equip::PLASTICS, Equip::COMPUTERS },
	  6300, 1, 0, StarSystem::PROD_INDUSTRY, 5,
	},{
	  "Precious metals", 0,
	  Equip::SLOT_CARGO, -1, { Equip::MINING_MACHINERY },
	  18000, 1, 0, StarSystem::PROD_MINING, 1,
	},{
	  "Industrial machinery",0,
	  Equip::SLOT_CARGO, -1, { Equip::METAL_ALLOYS, Equip::ROBOTS },
	  1300, 1, 0, StarSystem::PROD_INDUSTRY, 3,
	},{
	  "Farm machinery",0,
	  Equip::SLOT_CARGO, -1, { Equip::METAL_ALLOYS, Equip::ROBOTS },
	  1100, 1, 0, StarSystem::PROD_INDUSTRY, 3,
	},{
	  "Mining machinery",0,
	  Equip::SLOT_CARGO, -1, { Equip::METAL_ALLOYS, Equip::ROBOTS },
	  1200, 1, 0, StarSystem::PROD_INDUSTRY, 3,
	},{
	  "Air processors",0,
	  Equip::SLOT_CARGO, -1, { Equip::PLASTICS, Equip::INDUSTRIAL_MACHINERY },
	  2000, 1, 0, StarSystem::PROD_INDUSTRY, 3,
	},{
	  "Slaves",0,
	  Equip::SLOT_CARGO, -1, { },
	  23200, 1, 0, StarSystem::PROD_AGRICULTURE, 0,
	},{
	  "Hand weapons",0,
	  Equip::SLOT_CARGO, -1, { Equip::COMPUTERS },
	  12400, 1, 0, StarSystem::PROD_INDUSTRY, 4,
	},{
	  "Battle weapons",0,
	  Equip::SLOT_CARGO, -1, { Equip::INDUSTRIAL_MACHINERY, Equip::METAL_ALLOYS },
	  22000, 1, 0, StarSystem::PROD_INDUSTRY, 4,
	},{
	  "Nerve Gas",0,
	  Equip::SLOT_CARGO, -1, {},
	  26500, 1, 0, StarSystem::PROD_INDUSTRY, 3,
	},{
	  "Narcotics",0,
	  Equip::SLOT_CARGO, -1, {},
	  15700, 1, 0, StarSystem::PROD_INDUSTRY, 3,
	},{
	  "Military fuel",0,
	  Equip::SLOT_CARGO, -1, { Equip::HYDROGEN },
	  6000, 1, 0, StarSystem::PROD_INDUSTRY, 3,
	},{
	  "Rubbish",0,
	  Equip::SLOT_CARGO, -1, { },
	  -10, 1, 0, StarSystem::PROD_INDUSTRY, 0,
	},{
	  "Radioactive waste",0,
	  Equip::SLOT_CARGO, -1, { },
	  -35, 1, 0, StarSystem::PROD_INDUSTRY, 0,
	},{
