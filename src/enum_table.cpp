...
const struct EnumItem ENUM_InternalCameraControllerMode[] = {
	{ "FRONT", InternalCameraController::MODE_FRONT },
	{ "REAR", InternalCameraController::MODE_REAR },
	{ "LEFT", InternalCameraController::MODE_LEFT },
	{ "RIGHT", InternalCameraController::MODE_RIGHT },
	{ "TOP", InternalCameraController::MODE_TOP },
	{ "BOTTOM", InternalCameraController::MODE_BOTTOM },
	{ 0, 0 },
};
...
const struct EnumItem ENUM_ScannerMode[] = {
	{ "AUTO", ScannerWidget::SCANNER_MODE_AUTO },
	{ "MANUAL", ScannerWidget::SCANNER_MODE_MANUAL },
	{ 0, 0 },
};
...
const struct EnumItem ENUM_WorldViewCamType[] = {
	{ "INTERNAL", WorldView::CAM_INTERNAL },
	{ "EXTERNAL", WorldView::CAM_EXTERNAL },
	{ "SIDEREAL", WorldView::CAM_SIDEREAL },
	{ 0, 0 },
};
...
const struct EnumTable ENUM_TABLES[] = {
	{ "InternalCameraControllerMode", ENUM_InternalCameraControllerMode },
